...
class LodccTestCase( unittest.TestCase ):
    ...
    def test_ensure_valid_filename_from_url( self ):
        ...
        basenames = [ 
            ...
            # hard: set filename to dump_...rdf
            { 'url': 'http://dump.linkedopendata.it/musei', 'basename': 'dump_testfile.rdf' },
            { 'url': 'http://n-lex.publicdata.eu/resource/export/f/rdfxml?r=http%3A%2F%2Fn-lex.publicdata.eu%2Fgermany%2Fid%2FBJNR036900005', 'basename': 'dump_testfile.rdf' },
            { 'url': 'http://data.nobelprize.org', 'basename': 'dump_testfile.rdf' },
            { 'url': 'http://spatial.ucd.ie/lod/osn/data/term/k:waterway/v:river', 'basename': 'dump_testfile.rdf' },
        ]
