...
class MetricsTestCase( unittest.TestCase ):
    ...
    def test_out_degree( self ):
        """"""
        sod.out_degree( self.G, self.stats )
    ...
    def test_partial_out_degree( self ):
        """"""
        sod.partial_out_degree( self.G, self.stats )
    ...
    def test_labelled_out_degree( self ):
        """"""
        sod.labelled_out_degree( self.G, self.stats )
    ...
    def test_direct_out_degree( self ):
        """"""
        sod.direct_out_degree( self.G, self.stats )
